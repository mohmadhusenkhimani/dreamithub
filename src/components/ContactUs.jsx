...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "3555ce83-5d42-4f32-9dcd-ac537f25510c");
      ...
      <Title title='Reach out to us' desc='From strategy to execution, we craft digital solutions that move your business forward.'/>
        ...
        onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea name="message" rows={8} id="" placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' required></textarea>
            </div>
